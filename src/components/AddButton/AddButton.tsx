...
const AddButton: React.FC<AddButtonProps> = ({ onAddSpot, onAddPath, onExitMode, isSpotMode, isPathMode }) => {
    ...
    <>
      ...
      <div className="add-button-container">
        ...
        <div className="button-group">
          <button className={`add-button ${isMenuOpen ? 'active' : ''} ${isInAnyMode ? 'exit-mode' : ''}`} onClick={handleClick}>
            {isInAnyMode ? (
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={isMenuOpen ? 'rotated' : ''}>
                <path 
                  d="M12 5V19M5 12H19" 
                  stroke="white" 
                  strokeWidth="2.5" 

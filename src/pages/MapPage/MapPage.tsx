...
import SpotCreationForm, {
    type SpotFormData,
} from '../../components/SpotCreationForm/SpotCreationForm';
import RoadCreationForm, {
    type RoadFormData,
} from '../../components/RoadCreationForm/RoadCreationForm';
        ...
        try {
            ...
            if (middlePlacemark) {
                ...
                const expandHandler = function () {
                    ...
                    const pathIndex = savedPathsRef.current.findIndex(
                        (savedPath) => savedPath.firstPlacemark === middlePlacemark,
                    );
    ...
    return (
        <div className="map-container">
            <div className="map-header">
                ...
                <h1 className="map-title">Карта</h1>
                {isSpotMode && (
                    <div className="mode-indicator">Режим: Спот - кликните на карту</div>
                )}
                {isPathMode && (
            ...
            {showSpotForm && (
                <SpotCreationForm onSubmit={handleSpotFormSubmit} onCancel={handleSpotFormCancel} />
            )}
            {showRoadForm && (
                <RoadCreationForm onSubmit={handleRoadFormSubmit} onCancel={handleRoadFormCancel} />
            )}
        </div>
    );
};
